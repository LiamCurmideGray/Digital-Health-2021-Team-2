...
class GripStrength2 extends React.Component {
    constructor(props) {
        super(props);
        this.state = {};
    }
    ...
    render() {
        return (
            <div className="screen">
                    ...
                    <form>
                        <ol>
                            <form>
                                ...
                                <input type="radio" id="gst-question1-radio1" name="question1" value="right-hand" onChange={this.handleChange}/>
                                <label className="radio-button-label" for="gst-question1-radio1">Right Hand</label>
                                <br />
                                <input type="radio" id="gst-question1-radio2" name="question1" value="left-hand" onChange={this.handleChange}/>
                ...
                <a href="/GripStrength3" className="next-button" onClick={this.validateForm}>Next</a>
            </div>
        );
    }
}
