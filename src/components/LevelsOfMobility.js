...
function LevelsOfMobility() {
    ...
    function validateForm(){
        ...
        else if (question2 == "other" || question2 == "independent-and-walking-aid with "){
        ...
        <div className="screen">
            ...
            <div className="main-section">
                ...
                <h3 className="alert" id="question1-alert"></h3>
                    <div>
                        <input type="radio" id="radio-button-prev-ind-and-unaid" name="group1" value="indepedent-and-unaided" onChange={(e) => setAnswerQuestion1(e.target.value)} 
                        onClick={function () {
                        ...
                        <label className="radio-button-label" htmlFor="radio-button-prev-ind-and-unaid">Independent and Unaided</label>
                    </div>
                        <input type="radio" id="radio-button-prev-ind-and-walk-aid" name="group1" value="independent-and-walking-aid" 
                        onClick={function () {
                            document.getElementById("PreviousLevelOfMobilityFieldset").disabled = false; }}/>

                        <label className="radio-button-label" htmlFor="radio-button-prev-ind-and-walk-aid">Independent and Walking Aid</label>

                        <fieldset id="PreviousLevelOfMobilityFieldset" disabled={true}>
                        <div>
                            <input type="radio" id="radio-button-prev-stick" name="group1-1" value="stick" style={{ marginLeft: "7.5em" }} onChange={(e) => setAnswerQuestion1("independent-and-walking-aid with " + e.target.value)} />
                            <label className="radio-button-label" htmlFor="radio-button-prev-stick">Stick</label>
                        </div>
                        <div>
                            <input type="radio" id="radio-button-prev-roll-frame" name="group1-1" value="rollator-frame" style={{ marginLeft: "7.5em" }} onChange={(e) => setAnswerQuestion1("independent-and-walking-aid with " + e.target.value)}/>
                            <label className="radio-button-label" htmlFor="radio-button-prev-roll-frame">Rollator Frame</label>
                        </div>
                        <div>
                            <input type="radio" id="radio-button-prev-gutt-frame" name="group1-1" value="gutter-frame" style={{ marginLeft: "7.5em" }} onChange={(e) => setAnswerQuestion1("independent-and-walking-aid with " + e.target.value)}/>
                        ...
                        <div>
                            ...
                            <input type="text" id="left-hand-text-box" disabled={true} onBlur={(e) => setAnswerQuestion1("independent-and-walking-aid with " + e.target.value)} />
                ...
                <h3 className="alert" id="question2-alert"></h3>
                    <div>
                        <input type="radio" id="radio-button-prev-ind-and-unaid" name="group1" value="indepedent-and-unaided" onChange={(e) => setAnswerQuestion2(e.target.value)} 
                        onClick={function () {
                        ...
                        <div>
                            <input type="radio" id="radio-button-prev-stick2" name="group1-1" value="stick" style={{ marginLeft: "7.5em" }} onChange={(e) => setAnswerQuestion2("independent-and-walking-aid with " + e.target.value)} />
                            <label className="radio-button-label" htmlFor="radio-button-prev-stick">Stick</label>
                        </div>
                        <div>
                            <input type="radio" id="radio-button-prev-roll-frame2" name="group1-1" value="rollator-frame" style={{ marginLeft: "7.5em" }} onChange={(e) => setAnswerQuestion2("independent-and-walking-aid with " + e.target.value)}/>
                            <label className="radio-button-label" htmlFor="radio-button-prev-roll-frame">Rollator Frame</label>
                        </div>
                        <div>
                            <input type="radio" id="radio-button-prev-gutt-frame2" name="group1-1" value="gutter-frame" style={{ marginLeft: "7.5em" }} onChange={(e) => setAnswerQuestion2("independent-and-walking-aid with " + e.target.value)}/>
                            <label className="radio-button-label" htmlFor="radio-button-prev-gutt-frame">Gutter Frame</label>
                        </div>
                        <div>
                            <input type="radio" id="radio-button-prev-other2" name="group1-1" value="other" style={{ marginLeft: "7.5em" }} onClick={function () {
                            ...
                            <input type="text" id="left-hand-text-box2" disabled={true} onBlur={(e) => setAnswerQuestion2("independent-and-walking-aid with " + e.target.value)} />
